...
if(isset($_POST['sub'])){
    $c=$_POST['conta'];
    $dv=$_POST['digito'];
    $s= "select * from agencia where conta='$c' and digitoVerificador= '$dv'";   
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Log in </b> Agência</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Entre com a sua agência</p>
      ...
      <form method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Digito Verificador" name="digito">
          <div class="input-group-append">
            <div class="input-group-text">
      ...
      <p class="mb-0">
        <a href="registroAgencia.php" class="text-center">Registrar nova Agência</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>

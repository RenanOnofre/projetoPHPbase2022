            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <li class="list-group-item">
                  ...
                  <li class="list-group-item">
                    <b>Gênero</b> <a class="float-right"><?php echo $f['gender'];?></a>
                  </li>
                  <li class="list-group-item">
                ...
                <a href="homeTemplate.php" class="btn btn-primary btn-block"><b>Inicio</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link" data-toggle="tab">Dados</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
